...
public enum SemanticInteractionAnchor: Codable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .activity(turnID, activityID):
            try values.encode(Kind.activity, forKey: .type); try values.encode(turnID, forKey: .turnID); try values.encodeIfPresent(activityID, forKey: .activityID)
        case let .liveTail(turnID):
            try values.encode(Kind.liveTail, forKey: .type); try values.encode(turnID, forKey: .turnID)
        }
    }
}
