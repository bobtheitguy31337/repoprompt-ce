...
public enum ComposerControlValueWire: Codable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case let .boolean(value): try values.encode(Kind.boolean, forKey: .type); try values.encode(value, forKey: .value)
        case let .choice(value): try values.encode(Kind.choice, forKey: .type); try values.encode(value, forKey: .value)
        case let .choices(value): try values.encode(Kind.choices, forKey: .type); try values.encode(value, forKey: .value)
        }
    }
}
...
public struct ComposerContextWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case kind; case projectID = "projectId"; case sessionID = "sessionId" }
}
...
public enum ComposerControlWire: Codable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .toggle(common, value):
            try values.encode(Kind.toggle, forKey: .type); try values.encode(common, forKey: .common); try values.encode(value, forKey: .value)
        case let .singleChoice(common, selectedID, choices):
            try values.encode(Kind.singleChoice, forKey: .type); try values.encode(common, forKey: .common); try values.encode(selectedID, forKey: .selectedID); try values.encode(choices, forKey: .choices)
        case let .multiChoice(common, selectedIDs, choices):
            try values.encode(Kind.multiChoice, forKey: .type); try values.encode(common, forKey: .common); try values.encode(selectedIDs, forKey: .selectedIDs); try values.encode(choices, forKey: .choices)
        }
    }
}
...
public struct AgentEmptyStateWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case heading; case featuredWorkflowIDs = "featuredWorkflowIds"; case tips }
}
...
public struct ComposerSuggestionWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case kind, id, insertionText, displayName, detailText; case providerIDs = "providerIds"; case available }
}
...
public struct AgentTurnConfigurationWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion, catalogRevision; case providerID = "providerId", modelID = "modelId", effortID = "effortId", workflowID = "workflowId", permissionID = "permissionId"; case toolValues }
}
...
public struct AgentTurnContentWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion, text; case attachmentIDs = "attachmentIds"; case taggedFiles, resolvedSuggestionTokens }
}
...
public struct EffectiveTurnConfigurationWireSnapshot: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion, configuration, capabilityDigest; case actorID = "actorId", acceptedAt }
}
...
public struct SessionNextTurnDefaultsWireSnapshot: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion; case sessionID = "sessionId"; case revision, configuration, updatedAt }
}
...
public struct ComposerAttachmentWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion; case attachmentID = "attachmentId"; case displayName, mediaType, byteSize, digest, pixelWidth, pixelHeight, lifecycle, expiresAt, selectedProviderSupportsAttachment }
}

public struct ComposerAttachmentResolveRequest: Codable, Hashable, Sendable {
    public let attachmentIDs: [UUID]
    public init(attachmentIDs: [UUID]) { self.attachmentIDs = attachmentIDs }
...
public struct SubmissionReceipt: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case schemaVersion; case submissionID = "submissionId", acceptedAt, operation, sessionID = "sessionId", sessionRevision, requestAnchorID = "requestAnchorId", runID = "runId", generation, turnEpoch, runPhase, runStartedAt, consumedAttachmentIDs = "consumedAttachmentIds", consumedTaggedFiles, selectedConfiguration, session }
}
