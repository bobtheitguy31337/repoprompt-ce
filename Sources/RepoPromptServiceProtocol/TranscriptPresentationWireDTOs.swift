...
public struct AgentPresentationToolWire: Codable, Hashable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey { case executionID = "executionId", name, status, summary, displayArguments, displayResult, keyPaths; case processID = "processId"; case exitCode }
}
...
public enum AgentPresentationRowWire: Codable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .userRequest(id, text, attachmentIDs, taggedFiles):
            try values.encode(Kind.userRequest, forKey: .type); try values.encode(id, forKey: .id); try values.encode(text, forKey: .text); try values.encode(attachmentIDs, forKey: .attachmentIDs); try values.encode(taggedFiles, forKey: .taggedFiles)
        ...
        case let .tool(id, tool): try values.encode(Kind.tool, forKey: .type); try values.encode(id, forKey: .id); try values.encode(tool, forKey: .tool)
        case let .note(id, text): try encodeText(.note, id: id, text: text, into: &values)
        case let .error(id, text, code): try encodeText(.error, id: id, text: text, into: &values); try values.encodeIfPresent(code, forKey: .code)
        }
    }
...
public enum AgentPresentationBlockWire: Codable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .activityCluster(id, rows, summary): try values.encode(Kind.activityCluster, forKey: .type); try values.encode(id, forKey: .id); try values.encode(rows, forKey: .rows); try values.encode(summary, forKey: .summary)
        case let .groupedHistory(id, rows, title): try values.encode(Kind.groupedHistory, forKey: .type); try values.encode(id, forKey: .id); try values.encode(rows, forKey: .rows); try values.encode(title, forKey: .title)
        case let .collapsedHistoryRange(id, count, title): try values.encode(Kind.collapsedHistoryRange, forKey: .type); try values.encode(id, forKey: .id); try values.encode(count, forKey: .count); try values.encode(title, forKey: .title)
        ...
        case let .middleSummary(id, text): try values.encode(Kind.middleSummary, forKey: .type); try values.encode(id, forKey: .id); try values.encode(text, forKey: .text)
