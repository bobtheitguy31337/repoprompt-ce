...
public enum ServiceErrorCode: String, Codable, Sendable {
    case invalidRequest = "invalid_request", internalAuthFailed = "internal_auth_failed", authorizationDecisionRejected = "authorization_decision_rejected", notFound = "not_found", staleRevision = "stale_revision", controllerChanged = "controller_changed", interactionSettled = "interaction_settled", idempotencyConflict = "idempotency_conflict", runAlreadyActive = "run_already_active", cursorExpired = "cursor_expired", resourceDeleted = "resource_deleted", providerUnavailable = "provider_unavailable", capabilityMissing = "capability_missing", rootUnauthorized = "root_unauthorized", resumeUnsupported = "resume_unsupported", worktreeConflict = "worktree_conflict", rateLimited = "rate_limited", dependencyUnavailable = "dependency_unavailable", quiescing, persistenceUnavailable = "persistence_unavailable"
}
