...
public actor AgentTurnIntentCompiler {
    public struct Limits: Hashable, Sendable {
        ...
        public init(maximumTextBytes: Int = 64_000, maximumTaggedFiles: Int = 16, maximumTaggedFileBytes: Int = 1_048_576, maximumTaggedAggregateBytes: Int = 2_097_152, maximumTaggedAggregateTokens: Int = 500_000, maximumSuggestions: Int = 16, maximumAttachments: Int = 4) {
    ...
    public func compile(_ input: AgentTurnCompilationInput) async throws -> AgentTurnCompilationResult {
        ...
        for token in input.content.resolvedSuggestionTokens {
            ...
            resolvedSuggestions.append(try await suggestions.resolve(token, providerID: input.effectiveConfiguration.providerID, catalogRevision: input.effectiveConfiguration.catalogRevision))
        }
