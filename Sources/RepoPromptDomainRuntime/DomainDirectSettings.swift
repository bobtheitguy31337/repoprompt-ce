...
package enum DomainAppSettingsCatalog {
    ...
    package static let descriptors: [DomainSettingDescriptor] = [
        ...
        DomainSettingDescriptor(key: "models.temperature", group: "models", valueKind: .number, defaultValue: .number(0), description: "Global default model temperature."),
        bool("models.temperature_enabled", "models", true, "Whether the global temperature is sent with model requests."),
