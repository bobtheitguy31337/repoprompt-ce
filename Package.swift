...
let serverTestsEnabled = environment["REPOPROMPT_SERVER_TESTS"] != "0"
    ...
    let serverOnly = true
#else
    let serverOnly = serverOnlyFromEnvironment
#endif

private func makeServerPackage() -> Package {
    .init(
        name: "RepoPromptCE",
        platforms: [.macOS(.v14)],
        products: [
...
#if os(Linux)
    let package = makeServerPackage()
#else
    let package: Package = if serverOnly {
        makeServerPackage()
    } else {
        .init(
            name: "RepoPromptCE",
            ...
            targets: [
                ...
                .target(
                    ...
                    path: "Sources/RepoPromptServiceProtocol",
                    swiftSettings: swift6LanguageMode
                ),
                .target(
                ...
                .target(
                    ...
                    dependencies: ["RepoPromptServiceProtocol", "RepoPromptAgentRuntimeCore", "RepoPromptCodeMapCore", "RepoPromptC"],
                ...
                .target(
                    ...
                    path: "Sources/RepoPromptServicePersistence",
                    swiftSettings: swift6LanguageMode
                ),
                .target(
